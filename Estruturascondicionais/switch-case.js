function exibirInfoClasse(classe){
 switch(classe){
    ...
    console.log("Descrição: Os guerreiros são combatentes corpo a corpo resistentes, especializados no uso de armas e armaduras peasadas");
    console.log("Habilidades: Ataque poderoso, resistência adanos");
    break;
 case "Mago":
 ...
 case "Ladino":
    ...
    console.log("Descrição: Os ladrões são especialistas em furtividade e astúcia, capazes de realizar ataques furtivos e dersarmar armadilha.");
